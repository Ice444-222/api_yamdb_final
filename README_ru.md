# YaMDb Django
## Описание:
Реализован API для данного проекта на Django REST framework.
Проект YaMDb собирает отзывы пользователей на произведения. Сами произведения в YaMDb не хранятся,
здесь нельзя посмотреть фильм или послушать музыку. Произведения делятся на категории, такие как «Книги», «Фильмы», «Музыка».
...
```
git clone https://github.com/rerolll/yamdb_django
```
